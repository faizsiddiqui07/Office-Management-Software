                    ...
                    keyframes: [
                        ...
                        { morphSVG: "M12.1483 3.46366L12.8548 8.05624C12.9493 8.67024 12.8508 9.29842 12.573 9.85405L8.08541 18.8292C7.58673 19.8265 8.31198 21 9.42705 21H14.5729C15.688 21 16.4133 19.8265 15.9146 18.8292L11.427 9.85405C11.1492 9.29842 11.0507 8.67024 11.1452 8.05624L11.8517 3.46366C11.8778 3.29407 12.1222 3.29407 12.1483 3.46366Z", duration: 0.09 },
                        {
                            ...
                            onStart: () => {
                                gsap.to(
                                    button,
                                    { "--tab-bar-home-scale": 0.7, duration: 0.71, ease: "elastic.out(1, .9)" }
                                );
                    ...
                    keyframes: [
                        ...
                        { morphSVG: "M12 21C12 21 14.0216 19.0215 14.3637 16C14.6026 13.8898 13.5128 11.9823 13 10C12 6.134 13.134 3 12 3C10.866 3 12 6.134 11 10C10.4873 11.9823 9.39736 13.8898 9.6363 16C9.97843 19.0215 12 21 12 21Z", duration: 0.05 },
                        {
                            ...
                            onStart: () => {
                                gsap.to(
                                    button,
                                    { "--tab-bar-blog-scale": 0.7, duration: 0.7, ease: "elastic.out(1, .9)" }
                                );
                    ...
                    keyframes: [
                        ...
                        { morphSVG: "M12 21C12 21 14.0216 19.0215 14.3637 16C14.6026 13.8898 13.5128 11.9823 13 10C12 6.134 13.134 3 12 3C10.866 3 12 6.134 11 10C10.4873 11.9823 9.39736 13.8898 9.6363 16C9.97843 19.0215 12 21 12 21Z", duration: 0.05 },
                        {
                            ...
                            onStart: () => {
                                gsap.to(
                                    button,
                                    { "--tab-bar-marker-scale": 0.7, duration: 0.75, ease: "elastic.out(1, .9)" }
                                );
                    ...
                    keyframes: [
                        ...
                        { morphSVG: "M12 21C12 21 14.0216 19.0215 14.3637 16C14.6026 13.8898 13.5128 11.9823 13 10C12 6.134 13.134 3 12 3C10.866 3 12 6.134 11 10C10.4873 11.9823 9.39736 13.8898 9.6363 16C9.97843 19.0215 12 21 12 21Z", duration: 0.05 },
                        {
                            ...
                            onStart: () => {
                                gsap.to(
                                    button,
                                    { "--tab-bar-email-scale": 0.7, duration: 0.7, ease: "elastic.out(1, .9)" }
                                );
                    ...
                    keyframes: [
                        ...
                        { morphSVG: "M13.364 5.63604C14.0062 9.12971 7.68417 13.4401 8.36401 18.3639C8.84929 21.8787 15.1508 21.8787 15.6361 18.3639C16.316 13.4401 9.99389 9.12969 10.6361 5.63604C11.3564 1.71793 12.6438 1.71795 13.364 5.63604Z", duration: 0.05 },
                        {
                            ...
                            onStart: () => {
                                gsap.to(
                                    button,
                                    { "--tab-bar-linkedin-scale": 0.7, duration: 0.8, ease: "elastic.out(1, .9)" }
                                );
    ...
    if (type === 'home') {
        return (
            <button
                ...
                className={cn("home", isActive ? "active" : "")}>
    ...
    if (type === 'marker') {
        return (
            <button
                ...
                onClick={onClick}
                onMouseEnter={handleMouseEnter}
                className={cn("marker", isActive ? "active" : "")}>
                <svg viewBox="0 0 24 24">
                    <path
                        ref={pathRef}
    ...
    if (type === 'x') {
        return (
            <button
                ...
                onClick={onClick}
                onMouseEnter={handleMouseEnter}
                className={cn("x", isActive ? "active" : "")}>
                <svg viewBox="0 0 24 24">
                    <path
                        ref={pathRef}
                    ...
                    {hoveredIndex !== null && (
                        <motion.div
                            ...
                            <div
                                ...
                                <div
                                    className="relative h-4 flex items-center justify-center overflow-hidden w-full">
                        ...
                        <div
                            ...
                            <motion.div
                                ...
                                {isAnimated ? (
                                    ...
                                    <Icon
                                        className={cn('h-[22px] w-[22px] transition-colors duration-200', isHovered
